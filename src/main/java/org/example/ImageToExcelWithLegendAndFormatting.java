...
public class ImageToExcelWithLegendAndFormatting {

    public static void main(String[] args) {
        String imageName = "RW";
        String inputFormat = ".png";
        String imagePath = "C:\\Users\\Admin\\Desktop\\ImgToExcel\\" + imageName + inputFormat;
        String excelPath = "C:\\Users\\Admin\\Desktop\\ImgToExcel\\" + imageName + "_legend.xlsx";
        ...
        try {
            ...
            XSSFSheet imageSheet = workbook.createSheet(imageName);
            ...
            XSSFSheet legendSheet = workbook.createSheet("Legenda");
            ...
            for (Map.Entry<Color, String> entry : sortedLegend) {
                ...
                row.createCell(3).setCellValue(color.getRed());
                row.createCell(4).setCellValue(color.getGreen());
                row.createCell(5).setCellValue(color.getBlue());
            }
            ...
            workbook.close();
            System.out.println("Obraz z legendą i regułami formatowania został zapisany!");
        } catch (IOException e) {
