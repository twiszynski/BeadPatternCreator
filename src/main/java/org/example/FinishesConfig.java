...
public class FinishesConfig {
    ...
    static {
        ...
        abCrystal.put("BaseColor", 100);
        abCrystal.put("Opaque.png", 100);
        abCrystal.put("AB.png", 100);
        ...
        abLinedCrystalSparkling.put("AB.png", 100);
        ...
        abLinedSparkling.put("AB.png", 100);
        ...
        abSilverLinedGlazed.put("Opaque.png", 100);
        abSilverLinedGlazed.put("AB.png", 100);
        ...
        abTransparent.put("Transparent.png", 100);
        abTransparent.put("AB.png", 100);
        ...
        abTransparentMatte.put("Transparent.png", 100);
        abTransparentMatte.put("AB.png", 100);
        abTransparentMatte.put("Matte.png", 100);
        EFFECT_CONFIGS.put("ABTransparentMatte", abTransparentMatte);

        // Ceylon
        Map<String, Integer> ceylon = new LinkedHashMap<>();
        ceylon.put("BaseColor", 80);
        ceylon.put("Metallic.png", 100);
        EFFECT_CONFIGS.put("Ceylon", ceylon);

        // CeylonCrystal
        Map<String, Integer> ceylonCrystal = new LinkedHashMap<>();
        ceylonCrystal.put("BaseColor", 80);
        ...
        galvanizedFrosted.put("Metallic_strong.png", 100);
        galvanizedFrosted.put("Matte.png", 100);
        ...
        galvanizedMatte.put("Matte.png", 100);
        ...
        linedCrystal.put("BaseColor", 80);
        linedCrystal.put("Lined.png", 100);
        linedCrystal.put("Transparent_strong.png", 100);
        ...
        linedLusterCrystal.put("Opaque.png", 100);
        ...
        linedLusterSparkling.put("BaseColor", 80);
        linedLusterSparkling.put("Lined_strong.png", 100);
        linedLusterSparkling.put("Metallic.png", 100);
        ...
        linedSparkling.put("Metallic.png", 100);
        ...
        matteCrystal.put("BaseColor", 100);
        matteCrystal.put("Transparent_strong.png", 100);
        matteCrystal.put("Matte.png", 100);
        ...
        metallicAB.put("Metallic.png", 100);
        metallicAB.put("AB.png", 100);
        ...
        metallicABMatte.put("Metallic.png", 100);
        metallicABMatte.put("AB.png", 100);
        metallicABMatte.put("Matte.png", 100);
        ...
        metallicMatte.put("Matte.png", 100);
        ...
        metallicSatin.put("Satin.png", 100);
        ...
        opaqueCeylon.put("Opaque.png", 100);
        ...
        opaqueFrosted.put("Opaque.png", 100);
        opaqueFrosted.put("Matte.png", 100);
        ...
        opaqueGlazed.put("Matte.png", 100);
        ...
        opaqueMatte.put("Opaque.png", 100);
        opaqueMatte.put("Matte.png", 100);
        ...
        opaqueMatteGlazed.put("Opaque.png", 100);
        opaqueMatteGlazed.put("Matte.png", 100);
        ...
        opaqueSatin.put("Opaque.png", 100);
        ...
        transparentCrystal.put("BaseColor", 80);
